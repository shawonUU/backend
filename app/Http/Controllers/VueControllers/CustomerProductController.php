...
class CustomerProductController extends Controller
{
    ...
    {
        $products = CustomerProduct::where('user_id', Auth::user()->id)->orderBy('created_at', 'desc')->paginate(24);
    ...
    public function search(Request $request)
    {
        ...
        $customer_products = $customer_products->paginate(24)->appends(request()->query());
