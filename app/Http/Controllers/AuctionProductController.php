...
class AuctionProductController extends Controller
{
    ...
    public function auction_product_details(Request $request, $slug)
    {
        ...
        $related_products= Product::where('auction_product', 1)->get()->take(10);

        if ($detailedProduct != null) {
            return view('auction.frontend.auction_product_details', compact('detailedProduct','related_products','product_queries'));
        }
        abort(404);
    }
