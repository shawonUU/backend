...
Route::get('products/allpost', 'App\Http\Controllers\Api\V2\ProductController@allpostapi')->name('allpostapi');
Route::get('products/newproducts', 'App\Http\Controllers\Api\V2\ProductController@newproducts')->name('newproduct');
Route::get('v2/jobs', 'App\Http\Controllers\Api\V2\JobController@index')->name('alljobs');
Route::get('v2/job/{id}', 'App\Http\Controllers\Api\V2\JobController@show')->name('jobshow');
Route::get('v2/jobapplication', 'App\Http\Controllers\Api\V2\JobController@job_apply');
Route::post('v2/productstore','App\Http\Controllers\Api\V2\Seller\ProductController@productstore');
Route::post('v2/productupdate/{id}','App\Http\Controllers\Api\V2\Seller\ProductController@productupdate');
// Route::post('v2/sellerproductdetails/{id}', function(){
//     return "hello";
// });
Route::get('v2/sellerproductdetails/{id}', 'App\Http\Controllers\Api\V2\Seller\ProductController@seller_product_details');

Route::get('dropdowncategories', 'App\Http\Controllers\Api\V2\CategoryController@dropdowncategories');
...
Route::group(['prefix' => 'v2'], function() {
    ...
    Route::get('products/best-seller', 'App\Http\Controllers\Api\V2\ProductController@bestSeller');
          Route::get('products/allproductsm','App\Http\Controllers\Api\V2\ProductController@all_products');
       Route::get('products/all_auction_products','App\Http\Controllers\Api\V2\ProductController@all_auction_products');
