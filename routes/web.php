...
use App\Http\Controllers\VueHelperController;
...
Route::controller(VueHelperController::class)->group(function () {
 ...
 Route::post('/home/section/custom_section1', 'App\Http\Controllers\HomeController@load_custom_section')->name('home.section.custom_section_1');
