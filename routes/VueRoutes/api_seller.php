...
use App\Http\Controllers\VueControllers\Api\VUE\Seller\ConversationController;
use App\Http\Controllers\VueControllers\Api\VUE\Seller\CouponController;
use App\Http\Controllers\VueControllers\Api\VUE\Seller\OrderController;
use App\Http\Controllers\VueControllers\Api\VUE\Seller\ProductController;
use App\Http\Controllers\VueControllers\Api\VUE\Seller\ShopController;
use App\Http\Controllers\VueControllers\Api\VUE\Seller\RefundController;
use App\Http\Controllers\VueControllers\Api\VUE\Seller\SellerPackageController;
use App\Http\Controllers\VueControllers\Api\VUE\Seller\WithdrawRequestController;

Route::group(['prefix' => 'vue/seller', 'middleware' => ['app_language', 'auth:sanctum']], function () {
    //Order Section
