...
use App\Http\Controllers\VueControllers\AddressController;
use App\Http\Controllers\VueControllers\AizUploadController;
use App\Http\Controllers\VueControllers\Auth\LoginController;
use App\Http\Controllers\VueControllers\Auth\VerificationController;
use App\Http\Controllers\VueControllers\BlogController;
use App\Http\Controllers\VueControllers\CartController;
use App\Http\Controllers\VueControllers\CheckoutController;
use App\Http\Controllers\VueControllers\CompareController;
use App\Http\Controllers\VueControllers\ConversationController;
use App\Http\Controllers\VueControllers\CurrencyController;
use App\Http\Controllers\VueControllers\CustomerPackageController;
use App\Http\Controllers\VueControllers\CustomerProductController;
use App\Http\Controllers\VueControllers\DemoController;
use App\Http\Controllers\VueControllers\DigitalProductController;
use App\Http\Controllers\VueControllers\HomeController;
use App\Http\Controllers\VueControllers\InvoiceController;
use App\Http\Controllers\VueControllers\LanguageController;
use App\Http\Controllers\VueControllers\MessageController;
use App\Http\Controllers\VueControllers\NotificationController;
use App\Http\Controllers\VueControllers\PageController;
use App\Http\Controllers\VueControllers\PurchaseHistoryController;
use App\Http\Controllers\VueControllers\ReviewController;
use App\Http\Controllers\VueControllers\SearchController;
use App\Http\Controllers\VueControllers\SubscriberController;
use App\Http\Controllers\VueControllers\SupportTicketController;
use App\Http\Controllers\VueControllers\WalletController;
use App\Http\Controllers\VueControllers\Payment\AamarpayController;
use App\Http\Controllers\VueControllers\Payment\AuthorizenetController;
use App\Http\Controllers\VueControllers\Payment\BkashController;
use App\Http\Controllers\VueControllers\Payment\InstamojoController;
use App\Http\Controllers\VueControllers\Payment\MercadopagoController;
use App\Http\Controllers\VueControllers\Payment\NgeniusController;
use App\Http\Controllers\VueControllers\Payment\PayhereController;
use App\Http\Controllers\VueControllers\Payment\PaypalController;
use App\Http\Controllers\VueControllers\Payment\PaystackController;
use App\Http\Controllers\VueControllers\Payment\SslcommerzController;
use App\Http\Controllers\VueControllers\Payment\RazorpayController;
use App\Http\Controllers\VueControllers\Payment\StripeController;
use App\Http\Controllers\VueControllers\Payment\VoguepayController;
use App\Http\Controllers\VueControllers\Payment\IyzicoController;
use App\Http\Controllers\VueControllers\Payment\NagadController;
use App\Http\Controllers\VueControllers\Payment\PaykuController;
use App\Http\Controllers\VueControllers\ProductQueryController;
use App\Http\Controllers\VueControllers\ShopController;
use App\Http\Controllers\VueControllers\WishlistController;
use App\Http\Controllers\VueControllers\jobController;
use App\Http\Controllers\VueControllers\ApplicationController;
use App\Http\Controllers\VueControllers\VueHelperController;
use App\Http\Controllers\VueControllers\ErrorMessageController;
 ...
 */
 ...
 Route::get('/check', function(){
    // return auth()->user();
    $vl = session()->get('data1');
    if(!$vl) $vl = 1;
    else $vl++;
    session()->put('data1', $vl);
...
// Route::get('/session/set', function (Request $request) {return $request->key;
//     \Session::put($request->key, $request->value);
//     return response()->json(['status' => 'success']);
// });

// Route::get('/session/get', function (Request $request) {//return 'get';
//     \Session::get($request->key);
//     return response()->json(['value' => $value]);
// });



Route::get('/middleware-error-message', [ErrorMessageController::class, 'middlewareErrorMessage'])->name('middleware_error_message');


//  Vue Helper Routes
Route::controller(VueHelperController::class)->group(function () {
    Route::get('get-upload-asset','uploadAsset');
});

//  Route::get("/user_followed_shop", function(){
// //    return view("frontend.user.customer.followed_shop");
// })->name('user.followed.shop');
Route::get("/user_followed_shop", [HomeController::class, 'userFollowedShop'])->name('user.followed.shop')->middleware('auth:sanctum');


 Route::get("/todays_best_deals", function(){
   return view("frontend.todays_deal_details");
})->name('todays_best_deals');
 Route::get("/featured_products_more", function(){
   return view("frontend.featured_product_view_more");
})->name('featured.view');


 Route::post('/home/section/custom_section1', 'App\Http\Controllers\VueControllers\HomeController@load_custom_section')->name('home.section.custom_section_1');


Route::resource('job',jobController::class);
    Route::get('jobapplication', [jobController::class, 'job_apply'])->name('job.apply');
     Route::post('conversationsstore', [ConversationController::class, 'jobstore'])->name('jobstore');
...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/category/nav-element-list', 'get_category_items')->name('category.elements');
    ...
    Route::get('/product-variant_price', 'variant_price')->name('products.variant_price');
...
Route::controller(CartController::class)->group(function () {
    ...
    Route::get('/cart/removeFromCart', 'removeFromCart')->name('cart.removeFromCart');
...
//, 'verified', 'unbanned'
Route::group(['middleware' => ['vue_user', 'vue_unbanned']], function() {
...
// *****************
// *****************
// Route::middleware(['my-sanctum'])->group(function () {
//     Route::controller(HomeController::class)->group(function () {
//         Route::get('/dashboard', 'dashboard')->name('dashboard');
//     });
// });
...
Route::group(['middleware' => ['auth:sanctum','customer', 'verified', 'unbanned']], function() {
    ...
    Route::controller(PurchaseHistoryController::class)->group(function () {
        ...
        Route::get('/purchase_history/dontpay/{id}','dontpay')->name('purchase_history.dontpay');
...
Route::get('product-queries',[ProductQueryController::class,'store'])->middleware('auth:sanctum');
Route::post('product-queries-reply',[ProductQueryController::class,'reply'])->middleware('auth:sanctum');
...
Route::group(['middleware' => ['auth:sanctum']], function() {
    ...
    // Route::get('product-queries',[ProductQueryController::class,'index']);
...
Route::get('/home', [App\Http\Controllers\VueControllers\HomeController::class, 'index'])->name('home');

Route::get('/middleware-error-message', [App\Http\Controllers\VueControllers\ErrorMessageController::class, 'middlewareErrorMessage'])->name('middleware_error_message');
